...
Revision ID: 901e7973bc3c
Revises: 
Create Date: 2020-07-29 10:22:55.266184
...
def upgrade():
    ...
    sa.Column('web_site', sa.String(length=64), nullable=False),
    sa.Column('location', sa.String(length=24), nullable=False),
    sa.Column('description', sa.String(length=100), nullable=True),
    sa.Column('team_number', sa.String(length=256), nullable=True),
