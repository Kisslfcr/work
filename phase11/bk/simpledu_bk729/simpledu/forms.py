...
from wtforms import StringField, PasswordField, SubmitField, BooleanField, ValidationError, TextAreaField, IntegerField, DateTimeField
...
class CourseForm(FlaskForm):
    ...
    create_date = DateTimeField("create_date", format="%Y-%m-%d",default=datetime.date.today(),validators=[DataRequired()])
